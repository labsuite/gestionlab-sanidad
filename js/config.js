...
let DATA = {
  ...
  propuestasUbicacion: [], propuestasMaterial: [], fichasAtributos: [],
  configReservas: [], reservas: [],
  registrosCabina: [], registrosAutoclave: [], registrosVitrina: [],
  // Supabase
...
const COLS = {
  ...
  pedidos:            ['ID_Pedido','Nombre_Lista','Proveedor','Fecha_Creacion','Fecha_Presupuesto','Fecha_Aprobacion','Fecha_Pedido_Enviado','Fecha_Recepcion_Completa','Fecha_Factura','Estado','Numero_Presupuesto','Numero_Factura','Observaciones','Doc_Hoja_Generada','Doc_Hoja_Path','Doc_Hoja_Completada','Doc_Enviada_Jefatura','Ciclo','Modulo','Tipo','Gasto_Extra_Concepto','Gasto_Extra_Importe'],
  lineasPedido:       ['ID_Linea','Pedido','Material','ID_Material','Cantidad_Pedida','Cantidad_Recibida','Estado_Linea','Observaciones','Precio_Unitario','ID_Equipo'],
  ...
  propuestasMaterial:     ['ID_Propuesta','Categoria','Tipo_Base','Nombre_Base','Atributos','Texto_Etiqueta','Nombre_Generado','Unidad','Cantidad','ID_Ubicacion','Foto_Path','ID_Material_Sugerido','IA_Extraido','IA_Avisos','Propuesto_Por','Email_Propuesto_Por','Observaciones','Fecha','Estado','Revisado_Por','Fecha_Revision','Notas_Revision','ID_Material_Creado'],
  fichasAtributos:        ['ID_Ficha','Categoria','Tipo_Base','Nombre_Base','Orden','Atributos','Activa'],
  ...
  registrosVitrina:       ['ID_Registro','ID_Equipo','Usuario','Fecha','Hora_Inicio','Hora_Fin','Practica_Tecnica','Productos_Quimicos','Verificacion_Previa','Limpieza_Posterior','Incidencias','Estado']
};
